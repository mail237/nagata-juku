...
const problems = [
  {
    ...
    lines: ['文章題・応用', 'で手が止まる'],
    desc:
      '計算の型はなんとなくわかるのに、問題文を読むと「何を求められているか」がつかめず、そこで止まってしまう。式に落とすまでの一歩が抜けていることが多いです。',
  },
  {
    label: '直前勉強',
  ...
  },
  {
    ...
    desc:
      '「通っている安心」だけで、自習や復習が足りていないことがあります。塾での学びと、家庭での学習がつながっているか、一度見直してみてください。',
  },
] as const;
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection className="text-center mb-12 md:mb-16">
          ...
          <p className="mt-4 text-[#393939] text-sm md:text-base leading-relaxed max-w-2xl mx-auto text-left sm:text-center">
            成績だけでなく、勉強の習慣や志望校とのギャップまで、多くのご家庭が同じように悩んでいます。一人で抱え込まず、まずは原因を一緒に整理しましょう。
          </p>
        </FadeInSection>
