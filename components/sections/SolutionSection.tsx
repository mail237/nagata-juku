...
const steps = [
  {
    ...
    body: 'ICTで、どの単元につまずいているかを把握。データをもとに、お子さま一人ひとりのカリキュラムを組み立てます。',
    icon: (
  ...
  },
  {
    num: '02',
    title: 'ゲーム感覚で基礎を大量反復',
    body: '計算や英単語などの基礎は、ゲーム感覚でくり返し取り組める仕組みを用意。飽きずに続けられ、自然と身についていきます。',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    body: '基礎が固まれば、応用問題にもつながりやすくなります。焦らず土台から。小さな積み重ねが、大きな結果につながります。',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <FadeInSection className="mb-12 text-center">
          ...
          <p className="mt-4 text-sm text-[#555555] max-w-lg mx-auto leading-relaxed">
            定期テストで伸び悩んでいるなら、難問に手を出す前に、まず基礎を固めることが大切です。
          </p>
        </FadeInSection>
