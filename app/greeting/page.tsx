          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-[#F2F9FA] rounded-2xl p-8 md:p-10 border border-[#C7E5EB]/60 mb-10">
                ...
                <div className="flex flex-col gap-4 text-sm text-[#393939] leading-loose">
                  ...
                  <h3 className="font-serif text-lg md:text-[1.35rem] font-black text-[#1C4A52] leading-snug pt-1 pb-0.5 text-left">
                    <span className="block">「好きなこと」を仕事にする</span>
                    <span className="block">喜びを、次の世代へ。</span>
                  </h3>
              ...
              <div className="mb-10 rounded-2xl border border-[#C7E5EB]/50 bg-gradient-to-br from-[#FAFCFC] via-white to-[#F4F9F8] p-7 shadow-[0_4px_32px_rgba(28,74,82,0.06)] sm:p-8 md:p-10">
                <div className="flex flex-col gap-9 md:flex-row md:items-start md:gap-10 lg:gap-12">
                  ...
                  <div className="min-w-0 flex-1 md:pt-1">
                    ...
                    <h2 className="font-serif text-xl font-black leading-snug text-[#1C4A52] md:text-2xl">
                      <span className="block sm:inline">{seminarIntro.titleLine1}</span>
                      <span className="block sm:inline sm:ml-0">{seminarIntro.titleLine2}</span>
                    </h2>
            ...
            <FadeInSection delay={0.12}>
              <div className="bg-[#EBF6F8] rounded-2xl p-8 md:p-10 border border-[#C7E5EB]/60 mb-10">
                ...
                <h2 className="font-serif text-xl sm:text-2xl font-black text-[#1C4A52] mb-6 leading-snug text-left">
                  <span className="block sm:inline">「態度教育」——</span>
                  <span className="block sm:inline">心のコップを上に向ける</span>
                </h2>
                <div className="flex flex-col gap-4 text-sm text-[#393939] leading-loose">
