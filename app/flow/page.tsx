...
export const metadata: Metadata = {
  title: 'ご入塾までの流れ',
  description: '永田塾へのご入塾までの流れをご説明します。お問い合わせ→個別面談→体験授業→入塾まで丁寧にご案内します。',
};
...
const steps = [
  {
    num: '01',
    title: 'お問い合わせ',
    body: '「うちの子にも合うの？」「成績は本当に上がるの？」「もっと詳しく聞きたい」など、入塾に関するお問い合わせや個別相談（お子様の現状やお悩みをお聞きします）・無料体験授業のお申込みはこちらからお気軽にどうぞ。直接お電話いただいても大丈夫です。',
    note: 'お問い合わせ: 072-940-7683（月〜土 15:00〜22:00）',
    icon: (
  ...
  },
  {
    num: '02',
    title: '個別面談',
    body: 'お問い合わせをいただいたのち、ご希望の方は永田塾に来ていただき、お子様の現在の成績・学校や家庭での学習状況、保護者様のご要望・不安を感じていることなどをお聞きして、ご提案をします。お子様の性格や学習状況・テストの点数などから、どのような指導がお子様のためになるかをしっかりとご提案いたします。',
