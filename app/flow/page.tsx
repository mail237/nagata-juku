...
const steps = [
  {
    num: '01',
    title: 'お問合せ',
    body: '「うちの子に合う？」「本当に成績は上がる？」など、お気軽にお問合せください。個別相談（お子さまの現状やお悩みを伺います）・無料体験のお申込みは、フォームまたはお電話で承ります。',
  ...
  },
  {
    num: '02',
    title: '個別面談',
    body: 'ご希望の方は教室へお越しいただき、成績・学校や家庭での学習状況、保護者の方のご要望や不安をお聞きします。性格やテストの傾向を踏まえ、お子さまに合った指導の進め方をご提案します。',
  ...
  },
  {
    num: '03',
    title: '体験授業',
    body: '教室の雰囲気や授業の進め方は、実際に体験していただくのがいちばん確かです。無料体験は通常授業と同じ時間で行います。「分かる」「できる」の感覚を、お子さま自身に味わっていただきます。',
    note: '完全無料・体験後の勧誘なし',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    num: '04',
    title: '授業後面談',
    body: '体験後は面談を行い、授業中の様子やできていた点・つまずきをお伝えします。再度プランをご提案します。ご納得いただければ入塾となります。月の途中からの入塾も可能です。',
    note: '強引な勧誘は一切行いません',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
