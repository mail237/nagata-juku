...
export const metadata: Metadata = {
  title: 'お問合せ・無料体験申込み',
  description:
    '永田塾へのお問合せ・無料体験授業の申込みはこちら。電話・LINE・フォームからお気軽にご連絡ください。',
};
        ...
        <section className="bg-gradient-to-br from-[#EBF6F8] via-[#F2F9FA] to-[#F2F9FA] pt-32 pb-16 md:pb-20 relative overflow-hidden border-b border-[#C7E5EB]/60">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <FadeInSection>
              ...
              <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-black text-[#1C4A52] leading-snug mb-4">
                お問合せ・無料体験申込み
              </h1>
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-[#E0F2F4] shadow-sm">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        <a
                          ...
                          className="flex items-center justify-center gap-2 w-full px-5 py-3 bg-[#1C4A52] text-white font-bold rounded-xl text-sm hover:bg-black transition-colors"
                        >
